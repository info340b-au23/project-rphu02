                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="ci col col-sm-auto col-xl-12">
                                        <img src="/public/img/suzzallo.jpg" alt="the suzzallo library" className="pb-3" />
                                    </div>
                    ...
                    <div className="col col-md-6 col-xl-4 d-flex">
                        <div className="card mb-4">
                            <div className="card-body">
                                <div className="row">
                                    <div className="ci col col-sm-auto col-xl-12">
                                        <img src="./public/img/cs_building.jpg" alt="the computer science bulding" className="pb-3" />
                                    </div>
                                    <div className="col-sm">
                    ...
                    <div className="col col-md-6 col-xl-4 d-flex">
                        <div className="card mb-4">
                            <div className="card-body">
                                <div className="row">
                                    <div className="ci col col-sm-auto col-xl-12">
                                        <img src="./public/img/nano.jpg" alt="the nanoengineering building" className="pb-3" />
                                    </div>
                                    <div className="col-sm">
